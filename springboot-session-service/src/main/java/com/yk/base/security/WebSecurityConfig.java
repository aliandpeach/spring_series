...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter
{
    ...
    @Autowired
    private SpringCacheBasedUserCache springCacheBasedUserCache;
...
//                .antMatchers("/api/vip/**").hasRole("VIP")
    ...
    {
        // 增加缓存, 防止频繁访问数据库
        CachingUserDetailsService cachingUserDetailsService = new CachingUserDetailsService(sessionProvider.getUserDetailsService());
