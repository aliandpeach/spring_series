    ...
    public BaseResponse<Map<String, String>> log()
    {
        ...
        if (null != hibernateTemplate)
        {
            ...
            Map<String, Object> result = hibernateTemplate.execute(new HibernateCallback<Map<String, Object>>()
            {
                ...
                {
                    Object obj = session.createQuery("select count(1) from Role")
                            .list()
                            .iterator()
                            .next();
                    Object obj2 = session.createSQLQuery("select count(1) from t_session_role")
                            .list()
                            .iterator()
                            .next();
                    Object obj3 = session.createNativeQuery("select count(1) from t_session_role")
                            .list()
                            .iterator()
                            .next();
                    return null;
